...
class QuizListProvider extends GetConnect{
  ...
  Future<QuizListing?> getQuizList({required String type, int ?editorial_id,required String id}) async {
    ...
    final response = await _apiBaseHelper.post('exam_list', requestBody);
    try {
